...
@Command(
    ...
    description = ["Display information about Cardano eras and their transitions"]
)
class CardanoErasCommand : Callable<Int> {
    ...
    override fun call(): Int {
        try {
            ...
            // Display header
            println("=".repeat(80))
            println("Cardano Eras Information")
            println("=".repeat(80))
            println()
            ...
            println("Error: Failed to retrieve era information")
